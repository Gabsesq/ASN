...
source_asn_xlsx = "assets\Murdochs\Blank Murdochs UCC128 Label Request.xlsx"
...
def process_ScheelsLabel(file_path):
    ...
    backup_file = f"Finished/Scheels/Murdochs UCC128 Label Request {po_number} {current_date}.xlsx"
