...
def convert_xls_data(uploaded_file, dest_file):
    ...
    # Set static values and verify assignment
    source_ws['C14'] = "SAIA"
    source_ws['E14'] = "mixed"
    source_ws['G14'] = "mixed"
    source_ws['H14'] = 1
    print(f"Assigned static values to C14, E14, G14, H14")

    # Format and align cells
    format_cells_as_text(source_ws)
    align_cells_left(source_ws)

    # Save the updated copy and confirm save
    source_wb.save(dest_file)
    print(f"Workbook saved to {dest_file}")
